    ...
    def rename_file_names(self, file_dir, extention, save_dir):   
        ...
        for file_child_dir in sorted_subfolders:
            ...
            for i, file in enumerate(files):
                ...
                new_name = save_dir + "tuna2_" + "0"*(6-len(str(int(count))))+str(int(count)) + ".jpg" # change
...
if __name__ == "__main__":
    ...
    label_dir = "/home/tuna/Documents/Otopark/dataset_v2/"
    image_dir = "/home/tuna/Documents/Otopark/dataset_v2/"
    extention = ["/*.xml", "/*.jpg"]
    save_label_dir = "/home/tuna/Documents/Otopark/datas_with_labels/dataset_v2/"
    save_image_dir = "/home/tuna/Documents/Otopark/datas_with_labels/dataset_v2/"
